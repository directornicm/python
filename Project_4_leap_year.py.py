...
if year % 4 == 0:
    if year % 100 == 0:
        if year % 400 == 0:
            print(f"The year {year} is a leap year-1")
        else:
            print(f"The year {year} is not a leap year-2")
    else:
        print(f"The year {year} is a leap year-3")
else:
    print(f"The year {year} is not a leap year-4")
